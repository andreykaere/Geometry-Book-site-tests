...
label(Label("$A$"), A, SW, fontsize(13.5));
label(Label("$B$"), B, N, fontsize(13.5));
label(Label("$C$"), C, SE, fontsize(13.5));
...
dot(Label("$A_1$"), A1, S+W*0.1, fontsize(13.5));
dot(Label("$B_1$"), B1, N*1+E, fontsize(13.5));
dot(Label("$C_1$"), C1, fontsize(13.5));
